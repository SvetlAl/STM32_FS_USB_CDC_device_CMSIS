...
const uint8_t deviceDescriptor[DEVICE_DESCRIPTOR_LENGTH] = {
...
const uint8_t configurationDescriptor[CONFIGURATION_DESCRIPTOR_LENGTH] = {
	/*Configuration Descriptor*/
...
const uint8_t languageStringDescriptor[LANG_DESCRIPTOR_LENGTH] = {
...
const uint8_t manufactorStringDescriptor[MFC_DESCRIPTOR_LENGTH] = {
...
const uint8_t productStringDescriptor[PRODUCT_DESCRIPTOR_LENGTH] = {
...
const uint8_t serialNumberStringDescriptor[SERIAL_DESCRIPTOR_LENGTH] = {
...
const uint8_t deviceQualifierDescriptor[DEVICE_QUALIFIER_LENGTH] = {
...
const uint8_t stringInterface[INTERFACE_STRING_LENGTH] = {
...
const uint8_t configurationStringDescriptor[CONFIG_STRING_LENGTH] = {
